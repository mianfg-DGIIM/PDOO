...
module Deepspace
  ...
  class TestP1
    ...
    def self.main
      ...
      #SUPPLIES PACKAGE:
      while i<3
        paquete=SuppliesPackage.new(i,i,i)
      ...
      #SHIELD BOOSTER
      while i<3
        mejora=ShieldBooster.new("escudo_de_titanio",i,i)
      ...
      #WEAPON
      arma1=Weapon.new("canon", WeaponType::LASER, 0 )
      arma2=Weapon.new("bazooka", WeaponType::MISSILE, 1 )
      arma3=Weapon.new("plasma", WeaponType::PLASMA, 2 )
      puts "\n\nArma 1"
      print "  Tipo: "
